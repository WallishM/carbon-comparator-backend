...
export class Walk implements transportItfc{
    ...
    async getRoutingData(){
        await fetch(`https://api.geoapify.com/v1/routing?waypoints=${ this.transportData.start.lat},${this.transportData.start.long}|${this.transportData.end.lat},${this.transportData.end.long}&mode=walk&apiKey=${this.keyAPI}`)
